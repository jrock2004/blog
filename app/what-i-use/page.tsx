...
export default function WhatIUse() {
  const ulClasses =
    'mt-4 text-base font-medium text-text ml-5 md:list-inside md:ml-0 sm:mt-6 lg:text-lg';
      ...
      <div className="mt-14 flex flex-col gap-6">
        <Section title="Editor + Terminal + Fonts">
          <ul className={ulClasses}>
            ...
            <li className={liClasses}>
              <Link href="https://wezfurlong.org/wezterm/index.html">WezTerm</Link> is the terminal
              emulator I use.
            </li>
            <li className={liClasses}>
              <Link href="https://vercel.com/font">Geist font</Link> is the font I use in my editor
              and terminal.
            </li>
          </ul>
        </Section>
        ...
        <Section title="Desk Setup">
          <ul className={ulClasses}>
            ...
            <li className={liClasses}>
              The computer I am using on my desk is the M3 Macbook Pro:
              <ul className={`${ulClasses} mt-3 sm:mt-3 md:ml-8`}>
                <li className={liClasses}>Chip: Apple M3</li>
                <li className={liClasses}>Memory: 16 GB</li>
              </ul>
            </li>
            <li className={liClasses}>
